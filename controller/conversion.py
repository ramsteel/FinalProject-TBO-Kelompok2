...
# meminta konversion
def getconversion():    
    print('Grammar Sebelum Dikonversi ke Bentuk CNF : ')
    display(dct)    # pencetakan grammar sebelum dikonversi
    ...
    print('\n\nGrammar Setelah Dikonversi ke Bentuk CNF : ')
    display(dct)    # pencetakan setlah dilakukan konversi
